 ...
 * 																*/
	...
	/*	options	:		1 ~ 65535
	 * 															*/
	#define TIM4_PRESCALER			160								// for CNT_CLK = 10 KHz
	/*	options :		calculate as shown in upper notation
	 * 															*/
...
/*	to choose between generation or read PWM by TIM5
 * options	:		TIM5_READ_PWM
 * 					TIM5_GENERATE_PWM						*/
#define TIM5_USAGE				TIM5_GENERATE_PWM


/* 	to control in counter Clock (CNT_CLK) of TIM5
 * 	CNT_CLK  = TIMx_CLK / TIM5_PRESCALER
 * 	TIMx_CLK = APBx_CLK 		if (APBx_PRESCALER  = 1)
 * 	TIMx_CLK = APBx_CLK *2		if (APBx_PRESCALER != 1)
 * 																*/
	...
	/*	options	:		1 ~ 65535
	 * 															*/
	#define TIM5_PRESCALER			5000
	/*	options :		calculate as shown in upper notation
	 * 															*/
	#define TIM5_CNT_CLK			1600

#elif TIM5_USAGE == TIM5_GENERATE_PWM
	/*	options	:		1 ~ 65535
	 * 															*/
	#define TIM5_PRESCALER			160								// for CNT_CLK = 10 KHz
	/*	options :		calculate as shown in upper notation
	 * 															*/
	#define TIM5_CNT_CLK			100000
