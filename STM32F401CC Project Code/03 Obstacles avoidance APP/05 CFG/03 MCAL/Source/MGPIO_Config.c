...
GPIO_PinOperateMode_t const GPIOA_Pins_Array[GPIOA_PINS_MAX] =
		...
		/* PIN Status Mode*/
{		AF_PUSHPULL_80MHZ_,				/* PINA0  */				 /* ACD0 */ /* T2C1 */ /* T5C1 */
		AF_PUSHPULL_80MHZ_,		    	/* PINA1  */				 /* ACD1 */ /* T2C2 */ /* T5C2 */
		OUT_PUSHPULL_50MHZ_,  	 		/* PINA2  */    /* TX2 */    /* ACD2 */ /* T2C3 */ /* T5C3 */ /* T9C1 */
		AF_FREE,	    				/* PINA3  */    /* RX2 */    /* ACD3 */ /* T2C4 */ /* T5C4 */ /* T9C2 */
		OUT_PUSHPULL_50MHZ_,	   		/* PINA4  */                 /* ACD4 */
		IN_PULLUP,		   				/* PINA5  */	/* SCK1 */   /* ACD5 */ /* T2C1 */
		IN_PULLUP,		  				/* PINA6  */	/* MISO1 */  /* ACD6 */ /* T3C1 */
		IN_PULLUP,					 	/* PINA7  */	/* MOSI1 */  /* ACD7 */ /* T3C2 */
		AF_FREE,						/* PINA8  */				 /* T1C1 */
		AF_PUSHPULL_80MHZ_,				/* PINA9  */ 	/* TX1 */	 /* T1C2 */
		OUT_PUSHPULL_80MHZ_,			/* PINA10 */ 	/* RX1 */	 /* T1C3 */
		AF_PUSHPULL_80MHZ_,				/* PINA11 */    /* TX6 */	 /* T1C4 */
		AF_FREE,						/* PINA12 */    /* RX6 */
};
...
{		OUT_PUSHPULL_50MHZ_,			/* PINB0  */   /* ACD8 */	/* T3C3 */
		...
		IN_PULLUP,						/* PINB5  */				/* T3C2 */
		AF_PUSHPULL_80MHZ_,				/* PINB6  */   /* TX1 */	/* T4C1 */
		AF_PUSHPULL_80MHZ_,				/* PINB7  */   /* RX1 */	/* T4C2 */
		AF_PUSHPULL_80MHZ_,				/* PINB8  */				/* T10C1 */
		AF_PUSHPULL_80MHZ_,				/* PINB9  */				/* T4C4 */ /* T11C1 */
...
GPIO_PinOperateMode_t const GPIOC_Pins_Array[GPIOC_PINS_MAX] =
		/* PIN Status Mode*/
{		OUT_PUSHPULL_50MHZ_,			/* PINC13 */
		OUT_PUSHPULL_50MHZ_,			/* PINC14 */
		OUT_PUSHPULL_50MHZ_	     		/* PINC15 */
};
